 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(t){function e(R,j){var H=R.length;R.push(j);e:for(;0<H;){var ne=H-1>>>1,b=R[ne];if(0<i(b,j))R[ne]=j,R[H]=b,H=ne;else break e}}function n(R){return R.length===0?null:R[0]}function r(R){if(R.length===0)return null;var j=R[0],H=R.pop();if(H!==j){R[0]=H;e:for(var ne=0,b=R.length,O=b>>>1;ne<O;){var $=2*(ne+1)-1,K=R[$],C=$+1,se=R[C];if(0>i(K,H))C<b&&0>i(se,K)?(R[ne]=se,R[C]=H,ne=C):(R[ne]=K,R[$]=H,ne=$);else if(C<b&&0>i(se,H))R[ne]=se,R[C]=H,ne=C;else break e}}return j}function i(R,j){var H=R.sortIndex-j.sortIndex;return H!==0?H:R.id-j.id}if(typeof performance=="object"&&typeof performance.now=="function"){var s=performance;t.unstable_now=function(){return s.now()}}else{var o=Date,a=o.now();t.unstable_now=function(){return o.now()-a}}var l=[],u=[],c=1,h=null,d=3,m=!1,v=!1,w=!1,E=typeof setTimeout=="function"?setTimeout:null,p=typeof clearTimeout=="function"?clearTimeout:null,f=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function g(R){for(var j=n(u);j!==null;){if(j.callback===null)r(u);else if(j.startTime<=R)r(u),j.sortIndex=j.expirationTime,e(l,j);else break;j=n(u)}}function _(R){if(w=!1,g(R),!v)if(n(l)!==null)v=!0,tt(x);else{var j=n(u);j!==null&&te(_,j.startTime-R)}}function x(R,j){v=!1,w&&(w=!1,p(N),N=-1),m=!0;var H=d;try{for(g(j),h=n(l);h!==null&&(!(h.expirationTime>j)||R&&!V());){var ne=h.callback;if(typeof ne=="function"){h.callback=null,d=h.priorityLevel;var b=ne(h.expirationTime<=j);j=t.unstable_now(),typeof b=="function"?h.callback=b:h===n(l)&&r(l),g(j)}else r(l);h=n(l)}if(h!==null)var O=!0;else{var $=n(u);$!==null&&te(_,$.startTime-j),O=!1}return O}finally{h=null,d=H,m=!1}}var P=!1,D=null,N=-1,Y=5,W=-1;function V(){return!(t.unstable_now()-W<Y)}function ye(){if(D!==null){var R=t.unstable_now();W=R;var j=!0;try{j=D(!0,R)}finally{j?$e():(P=!1,D=null)}}else P=!1}var $e;if(typeof f=="function")$e=function(){f(ye)};else if(typeof MessageChannel<"u"){var Me=new MessageChannel,Ie=Me.port2;Me.port1.onmessage=ye,$e=function(){Ie.postMessage(null)}}else $e=function(){E(ye,0)};function tt(R){D=R,P||(P=!0,$e())}function te(R,j){N=E(function(){R(t.unstable_now())},j)}t.unstable_IdlePriority=5,t.unstable_ImmediatePriority=1,t.unstable_LowPriority=4,t.unstable_NormalPriority=3,t.unstable_Profiling=null,t.unstable_UserBlockingPriority=2,t.unstable_cancelCallback=function(R){R.callback=null},t.unstable_continueExecution=function(){v||m||(v=!0,tt(x))},t.unstable_forceFrameRate=function(R){0>R||125<R?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):Y=0<R?Math.floor(1e3/R):5},t.unstable_getCurrentPriorityLevel=function(){return d},t.unstable_getFirstCallbackNode=function(){return n(l)},t.unstable_next=function(R){switch(d){case 1:case 2:case 3:var j=3;break;default:j=d}var H=d;d=j;try{return R()}finally{d=H}},t.unstable_pauseExecution=function(){},t.unstable_requestPaint=function(){},t.unstable_runWithPriority=function(R,j){switch(R){case 1:case 2:case 3:case 4:case 5:break;default:R=3}var H=d;d=R;try{return j()}finally{d=H}},t.unstable_scheduleCallback=function(R,j,H){var ne=t.unstable_now();switch(typeof H=="object"&&H!==null?(H=H.delay,H=typeof H=="number"&&0<H?ne+H:ne):H=ne,R){case 1:var b=-1;break;case 2:b=250;break;case 5:b=1073741823;break;case 4:b=1e4;break;default:b=5e3}return b=H+b,R={id:c++,callback:j,priorityLevel:R,startTime:H,expirationTime:b,sortIndex:-1},H>ne?(R.sortIndex=H,e(u,R),n(l)===null&&R===n(u)&&(w?(p(N),N=-1):w=!0,te(_,H-ne))):(R.sortIndex=b,e(l,R),v||m||(v=!0,tt(x))),R},t.unstable_shouldYield=V,t.unstable_wrapCallback=function(R){var j=d;return function(){var H=d;d=j;try{return R.apply(this,arguments)}finally{d=H}}}})(K0);(function(t){t.exports=K0})(bx);/**
 * @license React
...
`,O$=T(b$)`
  fill: red;
  cursor: pointer;
`;function _g(t){const e=S.useContext(Ln);return y.jsx(y.Fragment,{children:t.likes.includes(e.uid)?y.jsx(O$,{onClick:()=>t.toggleLike(!0,e.uid,t.image.docID)}):y.jsx(L$,{onClick:()=>t.toggleLike(!1,e.uid,t.image.docID)})})}const $$=T.div`
  display: flex;
...
`;function Sg(t){return y.jsxs($$,{children:[y.jsx(M$,{type:"text",placeholder:"Add a comment...",maxLength:50,onChange:e=>t.setComment(e.target.value),value:t.comment,ref:t.inputRef}),y.jsx(U$,{type:"button",onClick:t.addComment,children:"Post"})]})}const F$=T.div`
  display: flex;
  padding-right: 20px;
...
`;function KC(t){const[e,n]=S.useState(!1),[r]=S.useState(t.commentsViewLimit);function i(o){n(o)}function s(){const o=[];for(let a=0;a<r;a++)o.push(y.jsx(S0,{comment:t.comments[a],comments:t.comments,setComments:t.setComments,upload:t.upload}));return o}return y.jsxs(B$,{children:[t.comments.length>r&&e===!1?y.jsx(y.Fragment,{children:s()}):t.comments.map(o=>y.jsx(S0,{comment:o,comments:t.comments,setComments:t.setComments,upload:t.upload},o.comment)),t.comments.length>r&&(e?y.jsx(C0,{onClick:()=>i(!1),children:"Show Less"}):y.jsx(C0,{onClick:()=>i(!0),children:"Show All"}))]})}const H$=T.div`
  display: none;
  flex-direction: column;
  height: fit-content;
...
`;function Jc(){const t=S.useContext(Ln),[e,n]=S.useState(window.innerWidth),[r,i]=S.useState([]),[s,o]=S.useState("");window.addEventListener("resize",()=>{n(window.innerWidth)}),S.useEffect(()=>{l()},[]);async function a(u){if(u.trim()){const h=(await mi(ve(pe,"users","userList"))).data().users,d=new RegExp(`^${u}w*`,"ig"),m=h.filter(v=>v.username.match(d));i(m)}else i([])}async function l(){const c=(await mi(ve(pe,"users",t.uid))).data(),h=await Jn(Kt(Qt,c.profilePictureURL));o(h)}return y.jsx(X$,{children:y.jsxs(J$,{children:[y.jsx(XC,{to:"/",children:e>700?y.jsx(ju,{children:"PXLshare"}):y.jsx(ju,{children:"PXL"})}),y.jsxs(Z$,{children:[y.jsx(eM,{type:"text",onChange:u=>a(u.target.value),maxLength:16,placeholder:"Search for users..."}),r.length>0?y.jsx(rM,{children:r.map(u=>y.jsx(iM,{to:`/p/${u.username}`,state:{uid:u.uid,disp:"gallery"},children:u.username},u.uid))}):null]}),y.jsxs(tM,{children:[e>700?y.jsx(lt,{to:"/upload",state:{profilePicture:!1},children:y.jsx(Cg,{})}):null,e>700?y.jsx(lt,{to:"/",children:y.jsx(QC,{})}):null,e>700?y.jsx(lt,{to:"/login",children:y.jsx(YC,{})}):null,y.jsx(lt,{to:`/p/${t.displayName}`,state:{uid:t.uid,disp:"gallery"},children:y.jsx(nM,{src:s})})]})]})})}const sM=T.div`
  position: absolute;
  width: 100%;
  bottom: 0px;
  display: flex;
...
`,nd=T.div`
  ...
  border-radius: 12px;
  animation: ${xg} 2s linear infinite;
`;function uM(){return y.jsxs(oM,{children:[y.jsxs(k0,{children:[y.jsx(aM,{}),y.jsx(nd,{})]}),y.jsx(lM,{}),y.jsxs(k0,{children:[y.jsx(GC,{}),y.jsx(om,{})]}),y.jsx(nd,{}),y.jsx(nd,{}),y.jsx(Sg,{})]})}const cM=T.div`
  width: 500px;
  margin: 0px auto;
...
`,qM=T(lt)`
  color: black;
  text-decoration: none;
`;function GM(t){return y.jsx(qM,{to:`/p/${t.user.username}`,state:{uid:t.user.uid},children:y.jsxs(HM,{children:[y.jsx(WM,{src:t.user.profPic,alt:""}),t.user.username]})})}const KM=T.div`
  display: flex;
  align-items: center;
  flex-direction: column;
  gap: 15px;
...
`;function L0(t){return y.jsx(KM,{children:t.users.map(e=>y.jsx(GM,{user:e},e.uid))})}const QM=T.div`
  position: relative;
  width: 300px;
  height: 300px;
`,YM=T.div`
...
`;function eU(t){return y.jsxs(QM,{children:[y.jsx(XM,{src:t.image.path}),y.jsxs(ZM,{children:[y.jsx(JM,{to:`/post/${t.image.imageInfo.docID}`,state:{upload:t.image.imageInfo,image:t.image.path,profilePicture:t.profilePicture,postLikes:t.image.imageInfo.likes}}),y.jsxs(YM,{children:[y.jsx(_g,{likes:t.image.imageInfo.likes,image:t.image.imageInfo,toggleLike:t.toggleLike}),t.image.imageInfo.likes?t.image.imageInfo.likes.length:0]})]})]})}const tU=T.div`
  display: grid;
  ...
  padding-top: 30px;
  border-top: 1px solid rgba(0, 0, 0, 0.2);
`;function nU(t){return y.jsx(tU,{children:t.images.map(e=>y.jsx(eU,{image:e,toggleLike:t.toggleLike,profilePicture:t.profilePicture},e.imageInfo.docID))})}const rU=t=>S.createElement("svg",{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 24 24",width:"16px",height:"16px",...t},S.createElement("path",{d:"M20.71,7.04C21.1,6.65 21.1,6 20.71,5.63L18.37,3.29C18,2.9 17.35,2.9 16.96,3.29L15.12,5.12L18.87,8.87M3,17.25V21H6.75L17.81,9.93L14.06,6.18L3,17.25Z"})),iU=t=>S.createElement("svg",{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 24 24",width:"18px",height:"18px",...t},S.createElement("path",{d:"M9,20.42L2.79,14.21L5.62,11.38L9,14.77L18.88,4.88L21.71,7.71L9,20.42Z"})),sU=t=>S.createElement("svg",{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 24 24",width:"72px",height:"72px",...t},S.createElement("path",{d:"M17 12C17 7.55 11.62 5.31 8.46 8.46C5.31 11.61 7.55 17 12 17C14.76 17 17 14.76 17 12M12 15C9.33 15 8 11.77 9.88 9.88C11.77 8 15 9.33 15 12C15 13.66 13.66 15 12 15M5 15H3V19C3 20.1 3.9 21 5 21H9V19H5M5 5H9V3H5C3.9 3 3 3.9 3 5V9H5M19 3H15V5H19V9H21V5C21 3.9 20.1 3 19 3M19 19H15V21H19C20.1 21 21 20.1 21 19V15H19"})),ox=mE`
  0% {
    background-color: rgb(170, 170, 170);
  }
...
`,Zs=T.div`
  ...
  border-radius: 12px;
  animation: ${ox} 2s linear infinite;
`;function uU(){return y.jsxs(oU,{children:[y.jsx(aU,{}),y.jsxs(lU,{children:[y.jsx("div",{children:y.jsx(Zs,{})}),y.jsxs("div",{children:[y.jsx(Zs,{}),y.jsx(Zs,{}),y.jsx(Zs,{})]}),y.jsx(Zs,{})]})]})}const cU=T.div`
  margin: 30px auto;
  max-width: 960px;
`,hU=T.div`
  display: none;
...
`;function vU(){const t=S.useContext(Ln),{uid:e}=Si().state,[n,r]=S.useState({}),[i,s]=S.useState(""),[o,a]=S.useState(""),[l,u]=S.useState(""),[c,h]=S.useState([]),[d,m]=S.useState([]),[v,w]=S.useState([]),[E,p]=S.useState([]),[f,g]=S.useState("gallery"),[_,x]=S.useState(!1),[P,D]=S.useState(!0),[N,Y]=S.useState({});S.useEffect(()=>{async function te(){const R=await wi(t.uid);p(R.following)}te()},[]),S.useEffect(()=>{Y({display:"none"}),h([]),D(!0),g("gallery"),V()},[e]);function W(){window.innerHeight<document.body.scrollHeight?r({position:"sticky"}):r({position:"absolute"})}async function V(){try{const R=(await mi(ve(pe,"users",e))).data(),j=await A$(e),H=await P$(e),ne=await D$(e),b=await Jn(Kt(Qt,R.profilePictureURL));m(j),w(H),s(R.username),u(R.bio),h(ne),a(b),D(!1),Y({display:"flex"})}catch(te){console.log(te)}}async function ye(){await at(ve(pe,"users",t.uid),{following:Ar(e)}),await at(ve(pe,"users",e),{followers:Ar(t.uid)});const te=await Jn(Kt(Qt,t.photoURL));p([...E,e]),m([...d,{uid:t.uid,profPic:te,username:t.displayName}])}async function $e(){await at(ve(pe,"users",t.uid),{following:ts(e)}),await at(ve(pe,"users",e),{followers:ts(t.uid)}),p(E.filter(te=>te!==e)),m(d.filter(te=>te.uid!==t.uid))}async function Me(te,R,j){if(te){await at(ve(pe,"users",e,"Uploads",j),{likes:ts(R)});const H=c.map(ne=>{if(ne.imageInfo.docID==j){let b=ne.imageInfo.likes.indexOf(R);ne.imageInfo.likes.splice(b,1)}return ne});h(H)}else{await at(ve(pe,"users",e,"Uploads",j),{likes:Ar(R)});const H=c.map(ne=>(ne.imageInfo.docID==j&&ne.imageInfo.likes.push(R),ne));h(H)}}async function Ie(te){te?(await at(ve(pe,"users",t.uid),{bio:l}),x(!1)):x(!0)}function tt(te){g(te)}return y.jsxs("div",{onLoad:W,children:[y.jsx(Jc,{}),y.jsxs(cU,{children:[P&&y.jsx(uU,{}),y.jsxs(hU,{style:N,children:[y.jsxs(fU,{children:[y.jsx(dU,{src:o}),y.jsx(lt,{to:"/upload",state:{profilePicture:!0},children:y.jsx(yU,{children:y.jsx(sU,{})})})]}),y.jsxs(pU,{children:[y.jsxs("div",{children:[y.jsx("h2",{children:i}),E.includes(e)==!0?y.jsx(O0,{onClick:$e,children:"Unfollow"}):t.uid!=e?y.jsx(O0,{onClick:ye,children:"Follow"}):null]}),y.jsxs("div",{children:[y.jsxs(id,{onClick:()=>tt("gallery"),children:[y.jsx(sd,{children:c.length})," Photos"]}),y.jsxs(id,{onClick:()=>tt("followers"),children:[y.jsx(sd,{children:d.length})," Followers"]}),y.jsxs(id,{onClick:()=>tt("following"),children:[y.jsx(sd,{children:v.length})," Following"]})]}),t.uid==e?_?y.jsxs("div",{children:[y.jsx("input",{type:"text",onChange:te=>u(te.target.value),placeholder:l}),y.jsx(gU,{onClick:()=>Ie(!0)})]}):y.jsxs("p",{children:[l,y.jsx(mU,{onClick:()=>Ie(!1)})]}):y.jsx("p",{children:l})]})]}),f==="gallery"?y.jsx(nU,{images:c,toggleLike:Me,profilePicture:o}):f==="followers"?y.jsx(L0,{users:d}):f==="following"?y.jsx(L0,{users:v}):null]}),y.jsx(Zc,{footerStyle:n})]})}const wU=T.div`
  display: flex;
  justify-content: center;
  align-items: center;
  height: 100vh;
...
`,IU=T.span`
  ...
  font-weight: bold;
  text-align: center;
`;function TU(){let t=Ps();const[e,n]=S.useState(!0);async function r(i,s){i.preventDefault();const o=Xc();if(s)try{const a=await wi("GuestAccount");await d0(o,a.email,a.password),t("/")}catch(a){console.log(a)}else try{const a=document.getElementById("email").value,l=document.getElementById("password").value;await d0(o,a,l),t("/")}catch(a){n(!1),console.log(a)}}return y.jsx(wU,{children:y.jsxs(EU,{children:[y.jsxs(_U,{onSubmit:i=>r(i),children:[y.jsx(ju,{children:"PXLshare"}),e?null:y.jsx(IU,{children:"Unable to login. Check email and password."}),y.jsx($0,{type:"email",placeholder:"Email Address",id:"email",required:!0}),y.jsx($0,{type:"password",placeholder:"Password",id:"password",required:!0}),y.jsx(SU,{type:"submit",children:"Login"})]}),y.jsxs(CU,{children:["Don't have an account? ",y.jsx(xU,{to:"/sign-up",children:"Sign Up"})]}),y.jsx("p",{children:"Wanna look around?"}),y.jsx(kU,{onClick:i=>r(i,!0),children:"Login as Guest"})]})})}const RU=T.div`
  display: flex;
  justify-content: center;
  align-items: center;
  height: 100vh;
...
`;function HU(){const t=S.useContext(Ln),e=S.useRef(null),n=Ps(),{upload:r,image:i,profilePicture:s,postLikes:o}=Si().state,[a,l]=S.useState(o),[u,c]=S.useState(""),[h,d]=S.useState(r.comments),m=new Date().getTime(),v=r.dateUploaded.seconds,w=Math.trunc(m/1e3/60/60/24-v/60/60/24);async function E(){if(u.trim())try{await at(ve(pe,"users",r.uid,"Uploads",r.docID),{comments:Ar({uid:t.uid,comment:u,username:t.displayName})}),d([...h,{uid:t.uid,comment:u,username:t.displayName}]),c("")}catch(g){console.log(g)}}async function p(g){g?(await at(ve(pe,"users",r.uid,"Uploads",r.docID),{likes:ts(t.uid)}),l(a.filter(_=>_!==t.uid))):(await at(ve(pe,"users",r.uid,"Uploads",r.docID),{likes:Ar(t.uid)}),l([...a,t.uid]))}function f(){e.current.focus()}return y.jsxs(y.Fragment,{children:[y.jsx(Jc,{}),y.jsxs(MU,{children:[y.jsx(BU,{src:i}),y.jsxs(zU,{children:[y.jsxs(FU,{children:[y.jsxs("div",{children:[y.jsx(VU,{src:s}),y.jsx(UU,{to:`/p/${r.username}`,state:{uid:r.uid},children:y.jsx("h2",{children:r.username})})]}),y.jsxs("div",{children:[y.jsx(U0,{onClick:()=>n(-1),children:"Back"}),t.uid===r.uid?y.jsx(U0,{onClick:()=>{N$(r),n(-1)},children:"Delete"}):null]})]}),r.desc?y.jsx(M0,{children:r.desc}):null,y.jsxs(jU,{children:[y.jsx(_g,{likes:a,image:r,toggleLike:p}),y.jsx(om,{onClick:f})]}),y.jsxs(M0,{children:[a.length," ",a.length==1?"Like":"Likes "]}),y.jsxs("p",{children:["Uploaded ",w>0?`${w} days ago`:"today"]}),y.jsx(KC,{comments:h,setComments:d,upload:r,commentsViewLimit:8}),y.jsx(Sg,{inputRef:e,addComment:E,setComment:c,comment:u})]})]}),y.jsx(Zc,{footerStyle:{position:"absolute"}})]})}const WU=NR`
...
`,Ln=S.createContext();function qU(){const[t,e]=S.useState(!0),[n,r]=S.useState(!0);return S.useEffect(()=>{const i=Xc();mO(i,s=>{s?(e(i.currentUser),r(!0)):r(!1)})},[]),y.jsx(Ln.Provider,{value:t,children:y.jsxs(LT,{basename:"/PXLshare",children:[y.jsx(WU,{}),y.jsxs(AT,{children:[y.jsx(Hr,{path:"/",element:n?y.jsx(hM,{}):y.jsx(TT,{to:"/login"})}),y.jsx(Hr,{path:"/upload",element:y.jsx(BM,{})}),y.jsx(Hr,{path:"/p/:id",element:y.jsx(vU,{})}),y.jsx(Hr,{path:"/login",element:y.jsx(TU,{})}),y.jsx(Hr,{path:"/sign-up",element:y.jsx(OU,{})}),y.jsx(Hr,{path:"/post/:id",element:y.jsx(HU,{})})]})]})})}ad.createRoot(document.getElementById("root")).render(y.jsx(At.StrictMode,{children:y.jsx(qU,{})}));
